...
namespace Piccolo
{
    ...
    public:
        ...
        /// cast a ray and find the hits  射线检测
        ...
        /// cast a shape and find the hits  物体的形状检测，类似于射线检测，但用于检测物体沿着某一方向的碰撞。
